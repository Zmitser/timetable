...
CREATE TABLE `progress` (
  ...
  `progresscol` datetime NOT NULL,
  `score` int(11) NOT NULL,
  `student_id` int(11) NOT NULL,
  `student_group_id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`,`student_id`,`student_group_id`,`subject_id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_progress_student1_idx` (`student_id`,`student_group_id`),
  KEY `fk_progress_subject1_idx` (`subject_id`),
  CONSTRAINT `fk_progress_student1` FOREIGN KEY (`student_id`, `student_group_id`) REFERENCES `student` (`id`, `group_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `timetable` VALUES (1,'2016-03-07 06:00:00','2016-03-07 07:35:00',1,1),(2,'2016-03-07 07:55:00','2016-03-07 09:30:00',1,2),(3,'2016-03-07 09:40:00','2016-03-07 11:15:00',1,3),(4,'2016-03-07 11:25:00','2016-03-07 13:00:00',1,4),(7,'2016-03-08 06:00:00','2016-03-08 07:35:00',1,5),(10,'2016-03-08 17:42:38','2016-03-08 09:30:00',1,3),(11,'2016-03-08 09:40:00','2016-03-08 11:15:00',1,2),(12,'2016-03-08 11:25:00','2016-03-08 13:00:00',1,6),(13,'2016-03-09 07:55:00','2016-03-09 09:30:00',1,7),(14,'2016-03-09 09:40:00','2016-03-09 11:15:00',1,8),(15,'2016-03-09 11:25:00','2016-03-09 13:00:00',1,9),(16,'2016-03-10 06:00:00','2016-03-10 07:35:00',1,7),(17,'2016-03-10 07:55:00','2016-03-10 09:30:00',1,1),(18,'2016-03-10 09:40:00','2016-03-10 11:15:00',1,11),(19,'2016-03-10 11:25:00','2016-03-10 13:00:00',1,3),(20,'2016-03-11 09:40:00','2016-03-11 11:15:00',1,5),(21,'2016-03-11 11:15:00','2016-03-11 13:00:00',1,2),(22,'2016-03-12 06:00:00','2016-03-12 07:35:00',1,12),(23,'2016-03-08 07:55:00','2016-03-08 09:30:00',1,13);
...
-- Dump completed on 2016-03-08 19:44:28
